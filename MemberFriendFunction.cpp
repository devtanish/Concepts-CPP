...
class Employee;
class ComplexNumber{
    public: int sumOfComplex(Employee, Employee);
};
class Employee{
    private: string name; int Id; int sallery;
    public:
        void setEmployeeDetails(string Name, int ID, int Sallery){
            name = Name; Id = ID; sallery = Sallery;
        }
...
int main() {
    Employee emp1, emp2;
    emp1.setEmployeeDetails("Tanish", 23, 5000); emp2.setEmployeeDetails("Rahul", 42, 6000);
    ComplexNumber obj;
